...
public class StreamApi {
    public static void main(String[] args) {
        ...
        List<String> department = studentList.stream().map(student -> student.engDepartment).distinct().collect(Collectors.toList());
        ...
        System.out.println("7.No male and female students are there in the computer science department: "+noOfStudents1+"\n");
    }
}
